		...
		},
		{
			...
			ui = {
				...
				hl_groups = {
					...
					ObsidianTodo = { bold = true, fg = "#EBCB8B" },
					ObsidianDone = { bold = true, fg = "#A3BE8C" },
					ObsidianRightArrow = { bold = true, fg = "#8FBCBB" },
					ObsidianTilde = { bold = true, fg = "#BF616A" },
					...
					ObsidianHighlightText = { bg = "#5E81AC" },
				},
			},
