...
local options = {
    ...
    binary         = true,                                                             -- Enable binary mode. Disable line endings and text encoding conversions.
    ...
    pumheight      = 15,                                                               -- Maximum height of the pop-up menu.
    ...
    wildignore     = { '*.o', '*.obj', '*.dll', '*.pyc', '*.class', '*/node_modules/*' }, -- Ignore these file types in command-line completion.
